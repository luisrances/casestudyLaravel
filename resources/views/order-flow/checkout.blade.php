...
<x-layout>
    ...
    {{-- Stock Alert Modal --}}
    <div id="stock-alert-modal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-yellow-100">
                    <svg class="h-6 w-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="items-center px-4 py-3">
                    <button id="stock-alert-close" class="px-4 py-2 bg-blue-500 text-white text-base font-medium rounded-md shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
                        OK
                    </button>
                </div>
            </div>
    ...
    {{-- custom alert div for payment method before proceeding to checkout --}}
    <div id="custom-alert-payment-method" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-yellow-100">
                    <svg class="h-6 w-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-2 px-7 py-3">
                    <p class="text-sm text-gray-500">Please provide all payment details to checkout.</p>
                </div>
                <div class="items-center px-4 py-3">
    ...
    <script>
        function showSuccessModal() {
            ...
            switch(paymentMethod) {
                case 'gcash':
                    ...
                    if (!gcashNumber) {
                        ...
                        document.getElementById('custom-alert-payment-method').classList.remove('hidden');
                    }
                    break;
                ...
                case 'bank_transfer':
                    ...
                    if (!accountName || !accountNumber) {
                        ...
                        if (!accountName) {
                            document.querySelector('input[name="account_name"]').classList.add('border-red-500'); 
                            document.getElementById('custom-alert-payment-method').classList.remove('hidden');
                        }
                        if (!accountNumber) {
                            document.querySelector('input[name="account_number"]').classList.add('border-red-500');
                            document.getElementById('custom-alert-payment-method').classList.remove('hidden');
                        }
                    }
                    break;
            ...
            document.getElementById('alert-close').addEventListener('click', function() {
                document.getElementById('custom-alert-payment-method').classList.add('hidden');
            });
