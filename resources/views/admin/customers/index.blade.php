    ...
    <div class="container px-4 main">
        ...
        <div class="row justify-content-md-between mb-3">
            <div class="col-12 col-md-5 col-lg-3 mb-2 mb-md-0">
                <a href="{{ route('customers.create') }}" class="btn w-100 text-black" style="background: #82C3EC;">Add Customer</a>
            </div>
                                ...
                                <tr style="vertical-align: middle;">
                                    ...
                                    <td style="width: 30%; vertical-align: middle;">
                                        <div class="row d-flex justify-content-evenly d-flex align-items-center gx-0">
                                            <div class="col-3">
                                                <a href="{{ route('customers.show', $customer) }}" class="btn btn-sm my-1 w-100" style="background: #82C3EC;">View</a>
                                            </div>
                                            <div class="col-3">
                                                <a href="{{ route('customers.edit', $customer) }}" class="btn btn-sm w-100" style="background: #82C3EC;">Edit</a>
                                            </div>
                                            <div class="col-3">
