...
<div class="container container-fluid main" style="max-height: 100%;">
    <h1 class="text-right mb-2 px-1 mt-md-4">Edit Payment Detail</h1>
    <form action="{{ route('payment_details.update', $paymentDetail) }}" method="POST">
        @csrf @method('PUT')
        @include('admin.payment_details.form')
