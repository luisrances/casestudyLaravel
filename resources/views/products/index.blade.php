                            ...
                            <tr style="vertical-align: middle; height: 100px;">
                                ...
                                <td style="width: 10%; vertical-align: middle;">
                                    @if ($product->image_path)
                                        <img src="{{ asset('storage/' . $product->image_path) }}" style="width: 80px; height: 80px; object-fit: cover;">
                                    @else
                                ...
                                <td style="width: 25%; vertical-align: middle;">
                                    <div class="row d-flex justify-content-evenly d-flex align-items-center gx-0">
                                        ...
                                        <div class="col-3">
                                            <a href="{{ route('products.edit', $product) }}" class="btn btn-sm btn-warning w-100">Edit</a>
                                        </div>
                                        <div class="col-3">
