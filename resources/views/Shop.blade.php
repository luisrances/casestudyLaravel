<x-layout>
  ...
  <!-- Main Content -->
  <main id="main-content" class="flex-1 overflow-y-auto p-8 space-y-10 h-screen">
    @foreach ([
      ...
      <section id="{{ $category }}" class="scroll-mt-8">
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Handle link clicks for smooth scrolling within the container
    navLinks.forEach(link => {
